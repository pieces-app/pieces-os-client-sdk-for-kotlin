...
import org.piecesapp.client.models.Notification
...
class NotificationsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun sendLocalNotification(notification: Notification?) : Unit {
        val localVariableBody: kotlin.Any? = notification
