...
class LocationApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun locationSpecificLocationSnapshot(location: kotlin.String, transferables: kotlin.Boolean?) : Location {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun locationUpdate(transferables: kotlin.Boolean?, location: Location?) : Location {
        val localVariableBody: kotlin.Any? = location
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (transferables != null) {
                    put("transferables", listOf(transferables.toString()))
