...
import org.openapitools.client.models.ImageAnalyses
...
class ImageAnalysesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun imageAnalysesSnapshot(transferables: kotlin.Boolean?) : ImageAnalyses {
        ...
        val localVarResponse = request<ImageAnalyses>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ImageAnalyses
