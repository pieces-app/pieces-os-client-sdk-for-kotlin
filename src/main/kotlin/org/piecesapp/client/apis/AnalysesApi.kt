...
import org.openapitools.client.models.Analyses
...
class AnalysesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun analysesSnapshot(transferables: kotlin.Boolean?) : Analyses {
        ...
        val localVarResponse = request<Analyses>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as Analyses
