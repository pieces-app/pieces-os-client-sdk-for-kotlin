...
import org.openapitools.client.models.SeededShare
...
class SharesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun sharesCreateNewShare(transferables: kotlin.Boolean?, seededShare: SeededShare?) : Shares {
        val localVariableBody: kotlin.Any? = seededShare
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sharesDeleteShare(share: kotlin.String) : kotlin.String {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/shares/{share}/delete".replace("{"+"share"+"}", "$share"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sharesSnapshot(transferables: kotlin.Boolean?) : Shares {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (transferables != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sharesSpecificShareSnapshot(share: kotlin.String, transferables: kotlin.Boolean?) : Share {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (transferables != null) {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/shares/{share}".replace("{"+"share"+"}", "$share"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
