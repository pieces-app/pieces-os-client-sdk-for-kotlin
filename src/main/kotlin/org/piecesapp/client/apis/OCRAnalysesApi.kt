...
import org.piecesapp.client.models.OCRAnalyses
...
class OCRAnalysesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun ocrAnalysesSnapshot(transferables: kotlin.Boolean?) : OCRAnalyses {
        ...
        val localVarResponse = request<OCRAnalyses>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as OCRAnalyses
