...
2. Download the Package from [Maven Central (Sonatype)](https://central.sonatype.com/artifact/app.pieces.pieces-os-client/pieces-os-client/overview) and add it as a dependency to your project.

### Pull Request

**1.** Fork the [repository](https://github.com/pieces-app/pieces-os-client-sdk-for-kotlin) on GitHub.
...
```bash
git remote add upstream https://github.com/pieces-app/pieces-os-client-sdk-for-kotlin
```
